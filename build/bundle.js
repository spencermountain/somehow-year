...
var app = (function () {
    ...
    /* src/Day.svelte generated by Svelte v3.25.1 */
    ...
    /* src/Year.svelte generated by Svelte v3.25.1 */
    const file = "src/Year.svelte";

    function add_css() {
    	var style = element("style");
    	style.id = "svelte-11t3cib-style";
    	style.textContent = ".year.svelte-11t3cib{position:relative;display:flex;flex-direction:row;justify-content:space-around;align-items:stretch;text-align:center;flex-wrap:nowrap;align-self:stretch;height:100%;min-height:100px}.vertical.svelte-11t3cib{flex-direction:column !important}.week.svelte-11t3cib{position:relative;flex:1;display:flex;flex-direction:column-reverse}.vertWeek.svelte-11t3cib{flex-direction:row}.day.svelte-11t3cib{border-radius:2px;flex:1;box-shadow:1px 1px 2px 0px rgba(0, 0, 0, 0.2);margin:1px}.square.svelte-11t3cib{width:100%}.square.svelte-11t3cib:after{content:'';display:block;padding-bottom:100%}.noday.svelte-11t3cib{flex:1;box-shadow:none !important}.weekend.svelte-11t3cib{background-color:rgba(245, 245, 245, 0.6)}.label.svelte-11t3cib{font-size:0.9rem}.twoMonthHor.svelte-11t3cib{padding-left:15px}.inMonthHor.svelte-11t3cib{position:relative;left:-15px}.twoMonthVer.svelte-11t3cib{padding-top:35px}.inMonthVer.svelte-11t3cib{position:relative;top:-35px}.line.svelte-11t3cib{font-size:8px;color:steelblue;margin-bottom:5px;box-shadow:2px 2px 1px 0px steelblue;height:1px}.noline.svelte-11t3cib{font-size:8px;margin-bottom:5px;height:1px;min-width:1px}@media only screen and (max-width: 800px){.twoMonthHor.svelte-11t3cib{padding-left:8px}.inMonthHor.svelte-11t3cib{left:-8px}}@media only screen and (max-width: 650px){.twoMonthHor.svelte-11t3cib{padding-left:2px}.inMonthHor.svelte-11t3cib{left:-2px}}@media only screen and (max-width: 400px){.day.svelte-11t3cib{border-radius:2px;margin:0px;box-shadow:1px 1px 2px 0px rgba(0, 0, 0, 0.1)}.twoMonthVer.svelte-11t3cib{padding-top:10px}.inMonthVer.svelte-11t3cib{top:-10px}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "day square svelte-11t3cib");
    			set_style(div, "background-color", /*d*/ ctx[13].color);
    			attr_dev(div, "title", div_title_value = /*d*/ ctx[13].iso);
    			toggle_class(div, "weekend", /*d*/ ctx[13].weekend);
    			toggle_class(div, "noday", /*d*/ ctx[13].noday);
    			toggle_class(div, "inMonthHor", !/*vertical*/ ctx[0] && /*d*/ ctx[13].monthChange && /*d*/ ctx[13].inMonth);
    			toggle_class(div, "inMonthVer", /*vertical*/ ctx[0] && /*d*/ ctx[13].monthChange && /*d*/ ctx[13].inMonth);
    			add_location(div, file, 192, 8, 4075);
    		},
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*weeks*/ 4 && div_title_value !== (div_title_value = /*d*/ ctx[13].iso)) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "noline svelte-11t3cib");
    			add_location(div, file, 204, 8, 4487);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "line svelte-11t3cib");
    			add_location(div, file, 202, 8, 4444);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(202:6) {#if i !== weeks.length - 1}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*i*/ ctx[12] !== /*weeks*/ ctx[2].length - 1) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			if_block.c();
    			t1 = space();
    			attr_dev(div, "class", "week svelte-11t3cib");
    			toggle_class(div, "vertWeek", /*vertical*/ ctx[0]);
    			toggle_class(div, "twoMonthHor", !/*vertical*/ ctx[0] && /*week*/ ctx[10][0].monthChange);
    			toggle_class(div, "twoMonthVer", /*vertical*/ ctx[0] && /*week*/ ctx[10][0].monthChange);
    			add_location(div, file, 186, 4, 3869);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(186:2) {#each weeks as week, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "label svelte-11t3cib");
    			add_location(div0, file, 183, 0, 3771);
    			attr_dev(div1, "class", "year svelte-11t3cib");
    			toggle_class(div1, "vertical", /*vertical*/ ctx[0]);
    			add_location(div1, file, 184, 0, 3804);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["date", "vertical", "label"];
    	...
    	return [vertical, label, weeks, date, $$scope, slots];
    }

    class Year extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-11t3cib-style")) add_css();
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { date: 3, vertical: 0, label: 1 });
    ...
    // (32:6) <Year date="march 2021" vertical={true}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(32:6) <Year date=\\\"march 2021\\\" vertical={true}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = space();
    			div3 = element("div");
    			div3.textContent = "vertical mode:";
    			t9 = space();
    			div4 = element("div");
    			create_component(year2.$$.fragment);
    			...
    			attr_dev(div2, "class", "m3 svelte-1rcg7lw");
    			add_location(div2, file$1, 28, 4, 564);
    			attr_dev(div3, "class", "m3 svelte-1rcg7lw");
    			set_style(div3, "padding-top", "40px");
    			add_location(div3, file$1, 29, 4, 587);
    			set_style(div4, "width", "50%");
    			add_location(div4, file$1, 30, 4, 654);
    			attr_dev(div5, "class", "container svelte-1rcg7lw");
    			add_location(div5, file$1, 20, 2, 367);
    			add_location(div6, file$1, 13, 0, 141);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(year0, div5, null);
    			append_dev(div5, t4);
    			append_dev(div5, div1);
    			append_dev(div5, t5);
    			mount_component(year1, div5, null);
    			append_dev(div5, t6);
    			...
    			mount_component(year2, div4, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			const year0_changes = {};
