...
var app = (function () {
    ...
    function add_css() {
    	...
    	style.id = "svelte-1iolde1-style";
    	style.textContent = ".year.svelte-1iolde1{display:flex;flex-direction:row;justify-content:space-around;align-items:stretch;text-align:center;flex-wrap:nowrap;align-self:stretch;height:100%;min-height:100px}.vertical.svelte-1iolde1{flex-direction:column !important}.week.svelte-1iolde1{flex:1;display:flex;flex-direction:column-reverse}.vertWeek.svelte-1iolde1{flex-direction:row}.day.svelte-1iolde1{border-radius:2px;flex:1;box-shadow:1px 1px 2px 0px rgba(0, 0, 0, 0.2);margin:1px}.square.svelte-1iolde1{width:100%}.square.svelte-1iolde1:after{content:'';display:block;padding-bottom:100%}.noday.svelte-1iolde1{flex:1;box-shadow:none !important}.weekend.svelte-1iolde1{background-color:rgba(245, 245, 245, 0.6)}.label.svelte-1iolde1{font-size:0.9rem}@media only screen and (max-width: 400px){.day.svelte-1iolde1{border-radius:2px;margin:0px;box-shadow:1px 1px 2px 0px rgba(0, 0, 0, 0.1)}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "day square svelte-1iolde1");
    			...
    			add_location(div, file, 114, 8, 2462);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "week svelte-1iolde1");
    			toggle_class(div, "vertWeek", /*vertical*/ ctx[0]);
    			add_location(div, file, 112, 4, 2385);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(112:2) {#each weeks as week}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "label svelte-1iolde1");
    			add_location(div0, file, 109, 0, 2290);
    			attr_dev(div1, "class", "year svelte-1iolde1");
    			toggle_class(div1, "vertical", /*vertical*/ ctx[0]);
    			add_location(div1, file, 110, 0, 2323);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Year extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1iolde1-style")) add_css();
